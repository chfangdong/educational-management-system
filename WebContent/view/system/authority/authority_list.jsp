<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.bfw.po.AuthorityInfo"%>
<%
...
<div class="row">
	...
	<div class="col-sm-2"  style=" padding-left:30px;">
    	<script type="text/jscript">
        	 ...
        	 <%List<AuthorityInfo> list =  (List<AuthorityInfo>)request.getAttribute("list");
        	 if(list!=null && list.size()>0){
        	 for(AuthorityInfo anth :list){%>
        	
			d.add(<%=anth.getAuthorityId()%>,<%=anth.getAuthorityPid()%>,'<%=anth.getAuthorityName()%>','anthorty/show.do?anthortyId=<%=anth.getAuthorityId()%>','','mainiframe');
			<%}}%>
           /*  d.add(1,0,'系统管理','','提示','');
