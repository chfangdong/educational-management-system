			...
			<div class="sidebar" id="sidebar">
			    ...
			    <a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> <%=dto.getAuth().getAuthorityName() %> </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							<%
								List<AuthorityInfo> list = dto.getList();
												if(list!=null&& list.size()>0){
													for(AuthorityInfo authinfo:list){
							%>
                            <li><a href="<%=authinfo.getAuthorityUrl() %>" target="mainframe"> <i
									class="icon-double-angle-right"></i> <%=authinfo.getAuthorityName() %>
							</a></li>
                    		<%}} %>
